...
if __name__ == "__main__":
    ...
    try:
        ...
        if not "gpus" in trainer_config:
         ...
         # =================【在这里添加代码】=================
        # 强制设置：跑完 100% 的训练数据才进行验证
        trainer_config["val_check_interval"] = 1.0
        # 强制设置：每 1 个 Epoch 验证一次
        ...
        # print("\n" + "="*50)
        # print("🚀 RUNNING IN FAST TEST MODE TO DEBUG CHECKPOINTING 🚀")
        # print("="*50 + "\n")
            
        #     # 从 trainer_opt (它是一个 Namespace 对象) 中覆盖参数
        # trainer_opt.max_epochs = 1          # 只运行一个 epoch
        # trainer_opt.limit_train_batches = 10 # 只用 10 个训练批次
        # # trainer_opt.limit_val_batches = 10   # 只用 10 个验证批次
